...
Flight::route('GET /clientes/@id:[0-9]+',function($id){
    $db=Flight::dbTarea();
...
Flight::route('POST /clientes/nuevoCliente',function(){
...
Flight::route('DELETE /clientes/eliminarCliente',function(){
...
Flight::route("PUT /clientes/actualizarCliente",function(){
    $idCliente=Flight::request()->data->id ?? null;
    ...
    $camposActualizadosString=[];
    $valoresCamposActualizados=[];
    ...
    Flight::json(array("success"=>true,"message"=>"Cliente modificado correctamente"));
